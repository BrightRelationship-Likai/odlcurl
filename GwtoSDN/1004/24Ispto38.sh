    ...
    "flow": [
	    ...
	    "cookie":"12",
		 ...
		 #   "ip-protocol":"1",
            ...
            "flow-name": "ext to 1004 38 118.1.1.0/24",
            "priority": "10000",
            "idle-timeout": "0",
            "hard-timeout": "0",
            "table_id": "0"
...
}' 'http://172.17.1.58:8181/restconf/config/opendaylight-inventory:nodes/node/openflow:147059310694/flow-node-inventory:table/0/flow/54'
