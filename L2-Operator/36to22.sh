curl -X PUT -H 'Accept: application/json, text/plain, */*' -H 'Accept-Language: en-US,en;q=0.5' --compressed -H 'Referer: http://172.17.1.58:8080/index.html' -H 'Content-Type: application/yang.data+json' -H 'Authorization: Basic YWRtaW46YWRtaW4=' -H 'Origin: http://172.17.1.58:8080' -H 'Connection: keep-alive' --data '{
    "flow": [
	    ...
	    "cookie":"10",
            "match": {
                "in-port": "openflow:147059310694:36",
                "vlan-match": {
                    "vlan-id": {
            ...
            "instructions": {
                "instruction": [
                                ...
                                },
			        {
                                    "order": "2",
                                    "set-dl-src-action": {
                                        "address": "00:50:00:00:00:03"
                                    }
                                },
                                {
                                    "order": "3",
                                    "output-action": {
                                        "output-node-connector": "openflow:147059310694:22"
                                    }
                                }
                            ]
                        }
...
}' 'http://172.17.1.58:8181/restconf/config/opendaylight-inventory:nodes/node/openflow:147059310694/flow-node-inventory:table/0/flow/22'
